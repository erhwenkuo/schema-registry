...
``schema.registry.zk.namespace``
  The string that is used as the |zk| namespace for storing schema registry metadata. Schema Registry instances which are part of the same schema registry service should have the same |zk| namespace.
